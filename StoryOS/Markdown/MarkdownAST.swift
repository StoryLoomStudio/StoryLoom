...
nonisolated struct ExtensionBlockNode: Equatable {
...
nonisolated indirect enum BlockNode: Equatable {
...
nonisolated enum DocumentAST {
    ...
    static func parse(_ text: String, scopedRanges: [NSRange]? = nil, precomputedBlocks: [MarkdownBlock]? = nil,
    ...
    private static func node(for block: MarkdownBlock, ns: NSString, scopedRanges: [NSRange]?, registry: ExtensionRegistry) -> BlockNode {
